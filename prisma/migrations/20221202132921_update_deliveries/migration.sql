...
-- AddForeignKey
ALTER TABLE "deliveries" ADD CONSTRAINT "deliveries_id_deliverman_fkey" FOREIGN KEY ("id_deliverman") REFERENCES "deliverman"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
